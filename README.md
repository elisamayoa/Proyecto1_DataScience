...
- `Análisis_Exploratorio.ipynb`: Jupyter Notebook con el análisis exploratorio de los datos. [Ver notebook]([link_a_tu_notebook](https://github.com/elisamayoa/Proyecto1_DataScience/blob/main/An%C3%A1lisis_Exploratorio.ipynb))
